...
db.execute("CREATE TABLE IF NOT EXISTS history (transaction_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, shares NUMERIC NOT NULL, symbol TEXT NOT NULL, price NUMERIC NOT NULL, timestamp DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, id INTEGER, FOREIGN KEY (id) REFERENCES users (id))")
